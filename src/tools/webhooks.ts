    ...
    "create_webhook",
    {
      ...
      inputSchema: {
        ...
        type: z.enum([
          ...
          "meeting_booked", "meeting_completed", "linkedin_message_sent",
          "linkedin_inmail_sent", "linkedin_connection_request_sent",
          "linkedin_connection_request_accepted", "linkedin_connection_request_withdrawn",
